...
export async function PATCH(req: NextRequest, { params }: { params: { id: string } }) {
  try {
    ...
    await logAdminActivity({
      ...
      action: "edit",
      description: `Adjusted the ${cycle.periodMonth} ${cycle.periodYear} cycle deadline to ${newDeadline.toLocaleDateString("en-US", { month: "short", day: "numeric", year: "numeric" })}`,
