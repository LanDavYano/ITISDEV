  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const res = await fetch("/api/auth/register", {
        ...
        body: JSON.stringify({ ...form, userType: "admin" }),
      })
      ...
      <div className="hidden lg:flex flex-col justify-between w-1/2 relative p-12 text-white">
        ...
        <div className="relative z-10">
          ...
          <p className="text-blue-100 max-w-sm">
            Restricted access. Only authorised administrators should register
            through this page.
          </p>
        </div>
      </div>
      ...
      <div className="flex-1 flex flex-col justify-center px-6 sm:px-12 lg:px-20 py-10">
        <div className="w-full max-w-md mx-auto">
          ...
          <p className="text-gray-500 dark:text-gray-400 mb-6">
            Register an admin account using your AIESEC email.{" "}
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div>
              ...
              <Input
                ...
                placeholder="juan.delacruz@aiesec.ph"
                value={form.email}
